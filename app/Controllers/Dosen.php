...
class Dosen extends BaseController
{
    ...
    public function insert()
    {
        if ($this->validate([
            ...
            'foto_dosen' => [
                'label'     => 'Foto Dosen',
                'rules'      => 'uploaded[foto_dosen]|max_size[foto_dosen,1024]|mime_in[foto_dosen,image/png,image/jpeg,image/jpg]',
                'errors'    => [
    ...
    public function update($id_dosen)
    {
        if ($this->validate([
            ...
            'foto_dosen' => [
                'label'     => 'Foto Dosen',
                'rules'      => 'max_size[foto_dosen,1024]|mime_in[foto_dosen,image/png,image/jpeg,image/jpg]',
                'errors'    => [
                    'max_size' => '{field} Max 1024 KB !!!',
                    'mime_in' => '{field} Format Foto Wajib Png,jpg,jpeg !!!'
                ]
